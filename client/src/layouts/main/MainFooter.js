    ...
    <RootStyle>
      <Container maxWidth="lg" sx={{ py: 5 }}>
        <Stack direction="row" justifyContent={'space-between'} mb={3}>
          <Stack spacing={3}>
            <Typography sx={{ fontSize: '22px' }}>Download the Daves app to explore any NFTs</Typography>
          ...
          <Stack spacing={3}>
            <Typography sx={{ fontSize: '22px' }}>Join Daves community</Typography>
            <Stack direction="row" spacing={3}>
        ...
        >
          <Grid container item xs={12} md={12} spacing={3}>
            <Grid item xs={6} md={3} justifyContent="space-between">
              <img src='/assets/home/logo.png' style={{ width: '230px', height: '90px' }} alt='footer-logo' />
              <Typography
                variant="overline"
                color="#adb5bd"
                sx={{
      ...
      >
        © 2022 Daves NFT. Design & Building by Alina.
      </Typography>
    </RootStyle>
  );
}
