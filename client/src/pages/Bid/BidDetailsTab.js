      ...
      <TabContext value={value}>
        ...
        <TabPanel value="1">
          <Typography sx={{ color: "#b9c6d8", mt: 2 }}>
            Hey guys! New exploration about NFT Marketplace Web Design, this time I'm inspired by one of my favorite NFT website called Daves (with crypto payment)! What do you think?
            <br />
            <br />
